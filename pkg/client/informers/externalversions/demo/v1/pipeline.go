	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BwarminskiV1().Pipelines(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BwarminskiV1().Pipelines(namespace).Watch(options)
			},
		},
		&demov1.Pipeline{},
		resyncPeriod,
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&demov1.Pipeline{}, f.defaultInformer)
}
